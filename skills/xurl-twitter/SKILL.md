---
name: xurl-twitter
description: Use the official xurl CLI for the X/Twitter API. Covers install, safe auth setup, app selection, common shortcuts, post, search, DM, media, v2 API, and raw endpoint access.
---
