---
name: design-throwaway-sketch
description: "Design throwaway HTML mockups: 2-3 design variants to compare."
version: 1.0.0
...
metadata:
  hermes:
    ...
    related_skills: [spike, design-one-off-html, popular-web-designs, excalidraw]
---
...
- User wants a production component — use `design-one-off-html` or build it properly
- User wants a polished one-off HTML artifact (landing page, deck) — `design-one-off-html`
