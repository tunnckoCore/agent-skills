...
description: "A collection of 54 real design systems (Stripe, Linear, Vercel) as HTML/CSS using design.md. Use as guidance or when user specifically ask you to design similar to popular vibes and sites."
version: 1.0.0
