---
name: himalaya-terminal-email
description: "Himalaya CLI: IMAP/SMTP email from terminal. Use when dealing with emails that is not Gmail/Google related products - for Google services use the google-workspace skill"
version: 1.1.0
author: community
license: MIT
