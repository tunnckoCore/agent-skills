---
name: matt-tdd
description: Test-driven development. Use when the user wants to build features or fix bugs test-first, mentions "red-green-refactor" or "matt tdd", or wants integration tests.
---
