...
description: |
  Generate comprehensive status reports for git repositories. 

  Use this skill when:
  - asked for the status of a git project/repo;
  - asked "what's going on in [project]" or "give me an overview of [repo]"
  - needs a project summary, progress report, or codebase overview
  - about recent commits, code structure, or project health

  **Output:** A rich, structured text report covering overview, branches, commit history, codebase breakdown, GitHub activity (PRs/issues/CI), dependency health, issues/errors, working tree changes, task management, and summary.
---
