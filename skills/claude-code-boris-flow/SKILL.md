---
name: claude-code-boris-flow
description: |
  Claude Code workflow tips from Boris Cherny (the creator) and the Claude Code team.
  USE ONLY WHEN INSIDE or setting up Claude Code: it covers optimizing workflows, running parallel sessions, configuring
  CLAUDE.md, using skills/commands, subagents, hooks, and more. 
