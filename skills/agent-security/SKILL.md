...
name: agent-security
version: 1.0.0
description: Security guardrails, self-audit tools, and secret scanning for AI agents. Use PROACTIVELY to ensure securing projects. Use when you have seen `.env` file in a project, or when the description of the project imply high-stakes, or when it is about web3/cryptocurrency.
author: axiom
